...
$(document).ready(function(){
	...
	var size = getPageSize(h);
		$('#dg').datagrid({     
		    url:'<%=basePath%>basicManage/getAppSwitchList',
			cache : false,
			type : 'post',
			title : '手机app开关维护',
		...
		var selected = $('#dg').datagrid('getSelected');
		 if (selected){
		       var index = $('#dg').datagrid('getRowIndex', selected);
		     	...
		     	var url = "<%=basePath%>basicManage/saveAppSwitchBefore?id="+selected.id;
				$.webox({
						height:580,
						width:800,
						bgvisibel:true,
	...
	function addDriverTag(){
		var url = "<%=basePath%>basicManage/saveAppSwitchBefore";
		$.webox({
				height:580,
				width:800,
				bgvisibel:true,
...
<body class="main easyui-layout" onresize="resizeGrid(400);">
	<dl class="tabs">
		...
		<dd class="form">
			<div class="batch">
				<input name="" id="" onclick="addDriverTag();" type="button" class="f_btn2"

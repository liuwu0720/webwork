...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#typeSel").change(function(){ 
			...
			if(null!=typeid&&""!=typeid){
				...
				var url = '<%=basePath%>subAdminStaffAction/getByRoleidAndTypeId?roleId='+roleId+'&typeId='+typeid;
	...
	function save(){
		...
		var url ="<%=basePath%>subAdminStaffAction/saveRoleResource?roleId="+roleId+"&resourceIds="+ids;
		$.post(url,function(data){
			showResponse(data);
		});
	}

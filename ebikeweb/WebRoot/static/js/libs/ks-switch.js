...
jQuery.fn.switchTab = function(settings) {
	...
	this.each(function() {
		...
		var ShowSTCon = function (oi){
			if(oi != curTagIndex){
				oTit.eq(curTagIndex).find("span").removeClass(settings.titOnClassName);
				oMain.hide();
				obj.find(settings.titCell + ":eq(" + oi + ")").find("span").addClass(settings.titOnClassName);
		...
		var ShowNext = function (){
			...
			oTit.eq(curTagIndex).find("span").addClass(settings.titOnClassName);

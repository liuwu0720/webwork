...
map.centerAndZoom(new BMap.Point('${tFineApplay.vcLongitude}','${tFineApplay.vcLatitude}'), 11);
...
//绘制罚款点坐标 
	var point = new BMap.Point('${tDetour.vcNoPlaceLongtide}','${tDetour.vcNoPlaceLatitude}');
